...
type AuthServiceClient interface {
	...
	// Refresh token
	RefreshToken(ctx context.Context, in *TokenRefreshRequest, opts ...grpc.CallOption) (*AuthResponse, error)
}
...
func (c *authServiceClient) RefreshToken(ctx context.Context, in *TokenRefreshRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
	out := new(AuthResponse)
...
type AuthServiceServer interface {
	...
	// Refresh token
	RefreshToken(context.Context, *TokenRefreshRequest) (*AuthResponse, error)
...
func (UnimplementedAuthServiceServer) RefreshToken(context.Context, *TokenRefreshRequest) (*AuthResponse, error) {
