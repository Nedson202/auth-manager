...
// Code is taken from: https://github.com/amsokol/go-grpc-http-rest-microservice-tutorial/blob/part3/pkg/protocol/rest/middleware/request-id.go
...
func AddLogging(logger *zap.Logger) (unaryServerInterceptors []grpc.UnaryServerInterceptor, streamServerInterceptors []grpc.StreamServerInterceptor) {
	...
	return unaryServerInterceptors, streamServerInterceptors
}
