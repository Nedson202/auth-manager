...
// Code is taken from: https://github.com/amsokol/go-grpc-http-rest-microservice-tutorial/blob/part3/pkg/protocol/rest/middleware/request-id.go, https://github.com/go-chi/chi/blob/master/middleware/request_id.go
